...
public class QsbAnimationController
    implements LauncherRootView.WindowStateListener,
  ...
  private void playAnimation(final boolean z, final boolean z2) {
    ...
    if (z) {
      ...
      Animator animator = ObjectAnimator.ofFloat(
          ...
          (float)((-mLauncher.getHotseat().getHeight()) / 2));
  ...
  private void a(final LauncherState launcherState) {
    if (mGoogleHasFocus && launcherState != LauncherState.ALL_APPS &&
        !mLauncher.hasWindowFocus()) {
