...
private final static String[] ICON_INTENTS =
	new String[] {"com.novalauncher.THEME",
...
static HashMap<String, CharSequence> getPackProviders(final Context context) {
	...
	for (String intent : ICON_INTENTS) {
		for (ResolveInfo info : pm.queryIntentActivities(
			     new Intent(intent), PackageManager.GET_META_DATA)) {
...
public static void reloadIcon(final DeepShortcutManager shortcutManager,
                              final LauncherModel model,
                              final UserHandle user, final String pkg) {
