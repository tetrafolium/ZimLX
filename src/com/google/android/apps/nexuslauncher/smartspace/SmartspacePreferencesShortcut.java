...
public SmartspacePreferencesShortcut() {
	super(R.string.smartspace_preferences, R.drawable.ic_smartspace_preferences,
...
private static boolean startSmartspacePreferences(final View view) {
	...
	launcher.startActivitySafely(
		view,
		new Intent(launcher, SettingsActivity.class)
		...
		.putExtra(SettingsActivity.SubSettingsFragment.CONTENT_RES_ID,
		          R.xml.zim_preferences_smartspace)
		.putExtra(SettingsActivity.SubSettingsFragment.HAS_PREVIEW, true),
		null);
	return true;
}
}
