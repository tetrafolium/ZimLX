...
public class SmartspaceCard {
  ...
  public SmartspaceCard(final Context context, final b di, final Intent mIntent,
                        final boolean dm, final Bitmap mIcon, final boolean dl,
                        final long dn, final long dj, final int dk) {
  ...
  static SmartspaceCard cD(final Context context, final i iVar,
                           final boolean z) {
    if (iVar != null) {
      try {
        ...
        Bitmap bitmap = iVar.dd == null ? null
                                        : BitmapFactory.decodeByteArray(
                                              iVar.dd, 0, iVar.dd.length, null);

        if (bitmap != null) {
          bitmap = ShadowGenerator.getInstance(context).recreateIcon(
              bitmap, true,
              new BlurMaskFilter(
                  (float)Utilities.pxFromDp(
                      3.0f, context.getResources().getDisplayMetrics()),
                  BlurMaskFilter.Blur.NORMAL),
              20, 55);
        }

        return new SmartspaceCard(context, iVar.de, parseUri, z, bitmap,
                                  iVar.dc, iVar.df, iVar.dh, iVar.dg);
      } catch (Throwable e) {
  ...
  private String cE(final e eVar) {
    ...
    if (minutesToEvent >= 60) {
      ...
      String hoursString =
          res.getQuantityString(R.plurals.smartspace_hours, hours, hours);
      if (minutes <= 0) {
        return hoursString;
      }
      String minutesString =
          res.getQuantityString(R.plurals.smartspace_minutes, minutes, minutes);
      return res.getString(R.string.smartspace_hours_mins, hoursString,
                           minutesString);
    }
    return res.getQuantityString(R.plurals.smartspace_minutes, minutesToEvent,
                                 minutesToEvent);
  }

  private com.google.android.apps.nexuslauncher.smartspace.nano.SmartspaceProto
      .d
      cG(final boolean b) {
    final c ch = this.cH();
    if (ch != null) {
  ...
  private int cJ(final e e) { return (int)Math.ceil(this.cI(e) / 60000.0); }
  ...
  private boolean cL(final com.google.android.apps.nexuslauncher.smartspace.nano
                         .SmartspaceProto.d d) {
    boolean b = false;
  ...
  private String cN(final boolean b) { return this.cO(b, null); }

  private String cO(final boolean b, final String s) {
    final com.google.android.apps.nexuslauncher.smartspace.nano.SmartspaceProto
        .d cg = this.cG(b);
  ...
  public String cA(final boolean b) { return this.cO(b, ""); }
  ...
  public String cC(final String s) { return this.cO(true, s); }

  public long cF() { return this.dI.cF.da; }
  ...
  public boolean cM() { return System.currentTimeMillis() > this.cF(); }
    ...
    case 1: {
      if (!Utilities.ATLEAST_NOUGAT) {
        try {
          ...
          return;
        } catch (URISyntaxException | NullPointerException |
                 SecurityException e) {
          e.printStackTrace();
        }
      }
  ...
  public String cy() { return this.cN(false); }

  public boolean cz() { return this.dL; }

  public Bitmap getIcon() { return this.mIcon; }

  public Intent getIntent() { return this.mIntent; }

  public String getTitle() { return this.cN(true); }

  public String toString() {
    return "title:" + this.getTitle() + " expires:" + this.cF() +
        " published:" + this.dN + " gsaVersion:" + this.dK +
        " gsaUpdateTime: " + this.dJ;
  }
}
