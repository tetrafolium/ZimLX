...
public class DoubleShadowTextClock extends TextClock {
    ...
    public DoubleShadowTextClock(final Context context, final AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public DoubleShadowTextClock(final Context context, final AttributeSet attributeSet, final int i) {
