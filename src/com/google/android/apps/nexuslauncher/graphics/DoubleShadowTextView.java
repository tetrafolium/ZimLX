...
public class DoubleShadowTextView extends TextView {
  ...
  public DoubleShadowTextView(final Context context) { this(context, null); }
  ...
  public DoubleShadowTextView(final Context context, final AttributeSet attrs,
    ...
    mShadowInfo =
        new DoubleShadowBubbleTextView.ShadowInfo(context, attrs, defStyleAttr);
    setShadowLayer(
        Math.max(mShadowInfo.keyShadowBlur + mShadowInfo.keyShadowOffset,
  ...
  protected void onDraw(final Canvas canvas) {
    ...
    getPaint().setShadowLayer(mShadowInfo.ambientShadowBlur, 0.0f, 0.0f,
