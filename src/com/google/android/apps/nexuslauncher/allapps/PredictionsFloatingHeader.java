...
@TargetApi(26)
public class PredictionsFloatingHeader
    extends FloatingHeaderView implements Insettable {
  private static final FloatProperty<PredictionsFloatingHeader> CONTENT_ALPHA =
      new FloatProperty<PredictionsFloatingHeader>("contentAlpha") {
        public void setValue(
            final PredictionsFloatingHeader predictionsFloatingHeader,
            final float f) {
  ...
  @Override
  public void setup(final AllAppsContainerView.AdapterHolder[] mAH,
                    final boolean tabsHidden) {
    mPredictionRowView.setup(
        this, Utilities.getZimPrefs(mContext).getShowPredictions());
  ...
  public PredictionRowView getPredictionRowView() { return mPredictionRowView; }
  ...
  public void setInsets(final Rect rect) {
    ...
    int i = deviceProfile.desiredWorkspaceLeftRightMarginPx +
            deviceProfile.cellLayoutPaddingLeftRightPx;
    mPredictionRowView.setPadding(i, mPredictionRowView.getPaddingTop(), i,
                                  mPredictionRowView.getPaddingBottom());
  ...
  public void setContentVisibility(final boolean hasHeader,
    ...
    propertySetter.setFloat(this, CONTENT_ALPHA, hasContent ? 1.0f : 0.0f,
                            interpolator);
    mPredictionRowView.setContentVisibility(hasHeader, hasContent,
                                            propertySetter, interpolator);
  }

  public void updateShowAllAppsLabel() {
    setShowAllAppsLabel(
        Utilities.ATLEAST_MARSHMALLOW &&
        Utilities.getZimPrefs(getContext()).getShowAllAppsLabel());
  }
