...
public class ActionIntentFilter {
  public static IntentFilter googleInstance(final String... array) {
    return newInstance("com.google.android.googlequicksearchbox", array);
  }

  public static IntentFilter newInstance(final String s,
                                         final String... array) {
  ...
  public static boolean googleEnabled(final Context context) {
    try {
      return context.getPackageManager()
          .getApplicationInfo("com.google.android.googlequicksearchbox", 0)
          .enabled;
