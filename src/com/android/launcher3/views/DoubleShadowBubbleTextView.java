...
/**
 * Extension of {@link BubbleTextView} which draws two shadows on the text
...
public DoubleShadowBubbleTextView(final Context context,
	...
	setShadowLayer(mShadowInfo.ambientShadowBlur, 0, 0,
...
public void onDraw(final Canvas canvas) {
	...
	getPaint().setShadowLayer(
		mShadowInfo.ambientShadowBlur, 0, 0,
	...
	getPaint().setShadowLayer(
		mShadowInfo.keyShadowBlur, 0.0f, mShadowInfo.keyShadowOffset,
...
public ShadowInfo(final Context c, final AttributeSet attrs,
                  final int defStyle) {

	TypedArray a =
		c.obtainStyledAttributes(attrs, R.styleable.ShadowInfo, defStyle, 0);

	ambientShadowBlur =
		a.getDimension(R.styleable.ShadowInfo_ambientShadowBlur, 0);
	ambientShadowColor =
		a.getColor(R.styleable.ShadowInfo_ambientShadowColor, 0);

	keyShadowBlur = a.getDimension(R.styleable.ShadowInfo_keyShadowBlur, 0);
	keyShadowOffset =
		a.getDimension(R.styleable.ShadowInfo_keyShadowOffset, 0);
