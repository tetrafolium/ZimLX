	...
	synchronized (sInstanceLock) {
		if (sInstance == null) {
			if (Utilities.ATLEAST_P) {
				...
				sInstance =
					new UserManagerCompatVNMr1(context.getApplicationContext());
...
public abstract CharSequence getBadgedLabelForUser(CharSequence label,
                                                   UserHandle user);
...
public abstract boolean requestQuietModeEnabled(boolean enableQuietMode,
                                                UserHandle user);
