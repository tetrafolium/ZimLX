...
// Create a separate reverse map as LongArrayMap.indexOfValue checks if
// objects are same and not {@link Object#equals}
...
@Override
public CharSequence getBadgedLabelForUser(final CharSequence label,
                                          final UserHandle user) {
	if (user == null) {
		return label;
	}
