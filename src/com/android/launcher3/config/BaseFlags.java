 ...
 * <p>
 * All the flags should be defined here with appropriate default values. To
 * override a value, redefine it in {@link }. <p> This class is kept
 * package-private to prevent direct access.
 */
...
// When enabled allows to use any point on the fast scrollbar to start
// dragging.
...
// When enabled the status bar may show dark icons based on the top of the
// wallpaper.
