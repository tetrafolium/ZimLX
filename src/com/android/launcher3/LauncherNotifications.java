...
private final Set<NotificationListener.NotificationsChangedListener>
mListeners = new HashSet<>();

public void addListener(
	final NotificationListener.NotificationsChangedListener listener) {
...
public void onNotificationPosted(final PackageUserKey postedPackageUserKey,
	...
	for (NotificationListener.NotificationsChangedListener listener :
	     mListeners) {
