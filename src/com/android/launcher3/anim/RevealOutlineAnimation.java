...
/**
 * A {@link ViewOutlineProvider} that has helper functions to create reveal
 * animations. This class should be extended so that subclasses can define the
 * reveal shape as the animation progresses from 0 to 1.
 */
public abstract class RevealOutlineAnimation extends ViewOutlineProvider {
  protected Rect mOutline;
  protected float mOutlineRadius;

  public RevealOutlineAnimation() { mOutline = new Rect(); }

  /**
   * Returns whether elevation should be removed for the duration of the reveal
   * animation.
   */
  ...
  public ValueAnimator createRevealAnimator(final View revealView,
    ...
    ValueAnimator va = isReversed ? ValueAnimator.ofFloat(1f, 0f)
  ...
  public float getRadius() { return mOutlineRadius; }

  public void getOutline(final Rect out) { out.set(mOutline); }
}
