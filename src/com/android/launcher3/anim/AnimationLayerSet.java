...
/**
 * Helper class to automatically build view hardware layers for the duration of
 * an animation.
 */
public class AnimationLayerSet extends AnimatorListenerAdapter {
  ...
  public AnimationLayerSet() { mViewsToLayerTypeMap = new ArrayMap<>(); }
  ...
  public void onAnimationStart(final Animator animation) {
    ...
    Iterator<Map.Entry<View, Integer>> itr =
        mViewsToLayerTypeMap.entrySet().iterator();
    while (itr.hasNext()) {
