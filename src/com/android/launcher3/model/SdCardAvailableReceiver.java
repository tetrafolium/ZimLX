 ...
 * <p>
 * During first load, just after reboot, some apps on sdcard might not be
 * available immediately due to some race conditions in the system. We wait for
 * ACTION_BOOT_COMPLETED and process such apps again.
 */
