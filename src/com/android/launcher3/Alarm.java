...
public class Alarm implements Runnable {
  ...
  // variable is true. We use this to avoid having multiple pending callbacks
  ...
  public Alarm() { mHandler = new Handler(); }

  public void setOnAlarmListener(final OnAlarmListener alarmListener) {
    mAlarmListener = alarmListener;
  }

  // Sets the alarm to go off in a certain number of milliseconds. If the alarm
  // is already set, it's overwritten and only the new alarm setting is used
  ...
  public void cancelAlarm() { mAlarmPending = false; }
  ...
  public boolean alarmPending() { return mAlarmPending; }
}
