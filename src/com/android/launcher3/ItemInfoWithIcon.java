...
/**
 * Indicates that the icon is disabled as the publisher has disabled the
 * actual shortcut.
 */
public static final int FLAG_DISABLED_BY_PUBLISHER = 1 << 4;

/**
 * Indicates that the icon is disabled as the user partition is currently
 * locked.
 */
public static final int FLAG_DISABLED_LOCKED_USER = 1 << 5;

public static final int FLAG_DISABLED_MASK =
	FLAG_DISABLED_SAFEMODE | FLAG_DISABLED_NOT_AVAILABLE |
	FLAG_DISABLED_SUSPENDED | FLAG_DISABLED_QUIET_USER |
	FLAG_DISABLED_BY_PUBLISHER | FLAG_DISABLED_LOCKED_USER;
...
/**
 * Flag indicating that the icon is an {@link
 * android.graphics.drawable.AdaptiveIconDrawable} that can be optimized in
 * various way.
 */
...
/**
 * Status associated with the system state of the underlying item. This is
 * calculated every time a new info is created and not persisted on the disk.
 */
