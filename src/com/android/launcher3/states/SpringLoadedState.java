...
public class SpringLoadedState extends LauncherState {
  ...
  private static final int STATE_FLAGS =
      FLAG_MULTI_PAGE | FLAG_DISABLE_ACCESSIBILITY | FLAG_DISABLE_RESTORE |
      FLAG_WORKSPACE_ICONS_CAN_BE_DRAGGED | FLAG_DISABLE_PAGE_CLIPPING |
      FLAG_PAGE_BACKGROUNDS | FLAG_HIDE_BACK_BUTTON;
  ...
  public void onStateEnabled(final Launcher launcher) {
    ...
    InstallShortcutReceiver.enableInstallQueue(
        InstallShortcutReceiver.FLAG_DRAG_AND_DROP);
