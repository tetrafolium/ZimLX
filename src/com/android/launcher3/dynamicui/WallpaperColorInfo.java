...
public class WallpaperColorInfo
  ...
  public boolean isDark() { return mIsDark; }

  public boolean supportsDarkText() { return mSupportsDarkText; }

  @Override
  public void onColorsChanged(final WallpaperColorsCompat colors,
                              final int which) {
  ...
  public void
  setOnThemeChangeListener(final OnThemeChangeListener onThemeChangeListener) {
  ...
  public interface OnThemeChangeListener { void onThemeChanged(); }
}
