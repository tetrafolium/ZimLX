...
public class FloatingHeaderView
    extends LinearLayout implements ValueAnimator.AnimatorUpdateListener {

  private final Rect mClip =
      new Rect(0, 0, Integer.MAX_VALUE, Integer.MAX_VALUE);
  ...
  private final RecyclerView.OnScrollListener mOnScrollListener =
      new RecyclerView.OnScrollListener() {
        ...
        @Override
        public void onScrolled(final RecyclerView rv, final int dx,
                               final int dy) {
          if (rv != mCurrentRV) {
            return;
          }
  ...
  private AllAppsRecyclerView setupRV(final AllAppsRecyclerView old,
                                      final AllAppsRecyclerView updated) {
  ...
  public boolean isExpanded() { return !mHeaderCollapsed; }
  ...
  public boolean hasVisibleContent() { return false; }
