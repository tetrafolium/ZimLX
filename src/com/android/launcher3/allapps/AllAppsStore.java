...
public class AllAppsStore {
  ...
  private final Set<FolderIcon> mFolderIcons =
  ...
  public Collection<AppInfo> getApps() { return mComponentToAppMap.values(); }
  ...
  public void updateIconBadges(final Set<PackageUserKey> updatedBadges) {
    updateAllIcons((child) -> {
      if (child.getTag() instanceof ItemInfo) {
        ...
        if (mTempKey.updateFromItemInfo(info) &&
            updatedBadges.contains(mTempKey)) {
  ...
  public interface OnUpdateListener { void onAppsUpdated(); }

  public interface IconAction { void apply(BubbleTextView icon); }
}
