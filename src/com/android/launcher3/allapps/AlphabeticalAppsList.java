...
public class AlphabeticalAppsList implements AllAppsStore.OnUpdateListener {
   ...
   * sections.
   */
  public List<AdapterItem> getAdapterItems() { return mAdapterItems; }

  /**
   * Returns the number of rows of applications
   */
  public int getNumAppRows() { return mNumAppRowsInAdapter; }

  /**
   * Returns the number of applications in this list.
   */
  public int getNumFilteredApps() { return mFilteredApps.size(); }

  /**
   * Returns whether there are is a filter set.
   */
  public boolean hasFilter() { return (mSearchResults != null); }
  ...
  public List<AppInfo> getFilteredApps() { return mFilteredApps; }
  ...
  public void setIsWork(final boolean isWork) { mIsWork = isWork; }
  ...
  public void reset() { updateAdapterItems(); }
}
