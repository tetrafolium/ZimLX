 ...
 * create an Intent that can be launched. <P>Type: TEXT</P>
 */
...
public static final Uri CONTENT_URI =
	Uri.parse("content://" + LauncherProvider.AUTHORITY + "/" + TABLE_NAME);

/**
 * The rank of this screen -- ie. how it is ordered relative to the other
 * screens. <P>Type: INTEGER</P>
 */
...
/**
 * Boolean indicating that his item was restored and not yet successfully
 * bound. <P>Type: INTEGER</P>
 */
public static final String RESTORED = "restored";

/**
 * Indicates the position of the item inside an auto-arranged view like
 * folder or hotseat. <p>Type: INTEGER</p>
 */
...
public static void addTableToDb(final SQLiteDatabase db,
                                final long myProfileId,
...
public static final Uri CONTENT_URI =
	Uri.parse("content://" + LauncherProvider.AUTHORITY + "/settings");

public static final String METHOD_CLEAR_EMPTY_DB_FLAG =
	"clear_empty_db_flag";
public static final String METHOD_WAS_EMPTY_DB_CREATED =
	"get_empty_db_flag";

public static final String METHOD_DELETE_EMPTY_FOLDERS =
...
public static final String METHOD_LOAD_DEFAULT_FAVORITES =
	"load_default_favorites";
...
public static final String METHOD_REMOVE_GHOST_WIDGETS =
	"remove_ghost_widgets";
