...
public class SystemUiController {
  ...
  public SystemUiController(final Window window) { mWindow = window; }

  public void updateUiState(final int uiState, final boolean isLight) {
    updateUiState(uiState, isLight ? (FLAG_LIGHT_NAV | FLAG_LIGHT_STATUS)
                                   : (FLAG_DARK_NAV | FLAG_DARK_STATUS));
  }
