...
/**
 * A wrapper around {@link Trace} to allow easier proguarding for production
 * builds. <p> To enable any tracing log, execute the following command: $ adb
 * shell setprop log.tag.TAGNAME VERBOSE
 */
