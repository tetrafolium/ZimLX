...
public class ViewGroupFocusHelper extends FocusIndicatorHelper {
  ...
  public void viewToRect(final View v, final Rect outRect) {
    ...
    // optimization, only consider this for the last node.
  ...
  private void computeLocationRelativeToContainer(final View child,
                                                  final Rect outRect) {
  ...
  /**
   * Sets the alpha of this FocusIndicatorHelper to 0 when a view with this
   * listener receives focus.
   */
