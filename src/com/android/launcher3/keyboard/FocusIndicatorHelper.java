...
public abstract class FocusIndicatorHelper
  ...
  /**
   * The fraction indicating the position of the focusRect between {@link
   * #mCurrentView} & {@link #mTargetView}
   */
  ...
  public void onFocusChange(final View v, final boolean hasFocus) {
    if (hasFocus) {
      ...
      if (mAlpha > MIN_VISIBLE_ALPHA) {
        ...
        mCurrentAnimation = ObjectAnimator.ofPropertyValuesHolder(
            this, PropertyValuesHolder.ofFloat(ALPHA, 1),
      ...
      if (mLastFocusedView == v) {
        ...
        endCurrentAnimation();
        mCurrentAnimation = ObjectAnimator.ofPropertyValuesHolder(
            this, PropertyValuesHolder.ofFloat(ALPHA, 0));
  ...
  /**
   * Simple subclass which assumes that the target view is a child of the
   * container.
   */
