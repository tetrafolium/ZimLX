 ...
 * preview is drawn horizontally centered, and scaled down if needed.
 *
 * This view does not support padding. Since the image is scaled down to fit the
 * view, padding will further decrease the scaling factor. Drag-n-drop uses the
 * view bounds for showing a smooth transition from the view to drag view, so
 * when adding padding support, DnD would need to consider the appropriate
 * scaling factor.
 */
