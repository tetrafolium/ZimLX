 ...
 */
public class WidgetsRecyclerView
    extends BaseRecyclerView implements OnItemTouchListener {
  ...
  public WidgetsRecyclerView(final Context context) { this(context, null); }
  ...
  public String scrollToPositionAtProgress(final float touchFraction) {
    ...
    layoutManager.scrollToPositionWithOffset(
        0, (int)-(availableScrollHeight * touchFraction));
  ...
  protected int getAvailableScrollHeight() {
    View child = getChildAt(0);
    return child.getMeasuredHeight() * mAdapter.getItemCount() -
        getScrollbarTrackHeight() - mScrollbarTop;
  }

  private boolean isModelNotReady() { return mAdapter.getItemCount() == 0; }
  ...
  @Override
  public void
  onRequestDisallowInterceptTouchEvent(final boolean disallowIntercept) {}
}
