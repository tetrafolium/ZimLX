...
public class LauncherScroller {
  ...
  private static final float INFLEXION =
      0.35f; // Tension lines cross at (INFLEXION, 1)
  ...
  private static float DECELERATION_RATE =
      (float)(Math.log(0.78) / Math.log(0.9));
   ...
   */
  public LauncherScroller(final Context context) { this(context, null); }

  /**
   * Create a Scroller with the specified interpolator. If the interpolator is
   * null, the default (viscous) interpolator will be used. "Flywheel" behavior
   * will be in effect for apps targeting Honeycomb or newer.
   */
   ...
   *
   * @param friction A scalar dimension-less value representing the coefficient
   *     of
   *                 friction.
   */
   ...
   *     the
   *                 content to the left.
   * @param dy       Vertical distance to travel. Positive numbers will scroll
   *     the
   *                 content up.
   ...
   *                  point.
   */
  public void fling(final int startX, final int startY, final int velocityX,
                    final int velocityY, final int minX, final int maxX,
   ...
   * further and longer, when used with {@link #setFinalX(int)} or {@link
   * #setFinalY(int)}.
   *
