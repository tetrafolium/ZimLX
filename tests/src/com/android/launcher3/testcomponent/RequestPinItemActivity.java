...
public class RequestPinItemActivity extends BaseTestingActivity {
  ...
  public void setRemoteViewColor(final int color) { mRemoteViewColor = color; }

  public void setShortcutId(final String id) { mShortcutId = id; }
  ...
  public void pinShortcut() {
    ...
    ShortcutInfo info =
        new ShortcutInfo.Builder(this, mShortcutId)
            .setIntent(
    ...
    IntentSender callback =
        mCallback == null ? null : mCallback.getIntentSender();
  ...
  private void requestWidget(final ComponentName cn) {
    ...
    if (mRemoteViewColor != Color.TRANSPARENT) {
      int layoutId = getResources().getIdentifier("test_layout_appwidget_view",
    ...
    AppWidgetManager.getInstance(this).requestPinAppWidget(cn, extras,
                                                           mCallback);
  }
}
