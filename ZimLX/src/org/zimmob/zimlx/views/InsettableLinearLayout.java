...
public InsettableLinearLayout(final Context context,
                              final AttributeSet attrs) {
	super(context, attrs);
}

public void setLinearLayoutChildInsets(final View child, final Rect newInsets,
	...
	if (child instanceof Insettable) {
		((Insettable)child)
		.setInsets(
			new Rect(newInsets.left, newTop, newInsets.right, newBottom));
...
public void onViewAdded(final View child) {
	...
	if (mInsetsSet) {
		throw new IllegalStateException(
			      "Cannot modify views after insets are set");
	}
}
