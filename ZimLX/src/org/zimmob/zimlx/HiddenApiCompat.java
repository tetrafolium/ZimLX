...
public class HiddenApiCompat {
  ...
  /*    public static boolean tryAccess() {
          ...
          try {
              //ThreadedRenderer.class.getMethod("setContextPriority",
     int.class); return true; } catch (NoSuchMethodException e) { return false;
          }
      }
      ...
      public static Bitmap loadTaskDescriptionIcon(TaskDescription desc, int
     userId) { return
     TaskDescription.loadTaskDescriptionIcon(desc.getIconFilename(), userId);
      }*/
}
