...
public static final String DESKTOP_OVERLAP_WIDGET =
	"pref_key__overlap_widget";
...
public static final String APPDRAWER_HIDE_APP_LABEL =
	"pref_hideAllAppsAppLabels";
public static final String APPDRAWER_SHOW_PREDICTIONS =
	"pref_show_predictions";
