...
public class Config {
  ...
  @NotNull public final Set<String> minibarItems = new HashSet<>();
  ...
  public String[] getDefaultIconPacks() {
    String[] iconPacks = context.getResources().getStringArray(
        R.array.config_default_icon_packs);
  ...
  public boolean enableLegacyTreatment() {
    return context.getResources().getBoolean(
        R.bool.config_enable_legacy_treatment);
  }

  public boolean enableColorizedLegacyTreatment() {
    return context.getResources().getBoolean(
        R.bool.config_enable_colorized_legacy_treatment);
  }

  public boolean enableWhiteOnlyTreatment() {
    return context.getResources().getBoolean(
        R.bool.config_enable_white_only_treatment);
  }
  ...
  public float getDefaultBlurStrength() {
    ...
    context.getResources().getValue(R.dimen.config_default_blur_strength,
                                    typedValue, true);
