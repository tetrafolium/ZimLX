...
public class WallpaperManagerCompatVL extends WallpaperManagerCompat {
  ...
  parseValue(final String value) {
    ...
    return Pair.create(
        wallpaperId,
        new WallpaperColorsCompat(primary, secondary, tertiary, 0 /* hints */));
  }
  ...
  public static class ColorExtractionService
    ...
    public void run() {
      ...
      if (info != null) {
        ...
        if (Utilities.ATLEAST_NOUGAT) {
          if (checkSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE) !=
            ...
            // documentation for Activity#requestPermissions for more details.
            return;
          }
      ...
      if (bitmap != null) {
        int color =
            findDominantColorByHue(bitmap, MAX_WALLPAPER_EXTRACTION_AREA);
        value += "," + color;
      }
