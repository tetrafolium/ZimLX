...
public class ColorExtractionAlgorithm {
    ...
    private static final TonalPalette[] TONAL_PALETTES = {
        new TonalPalette(
        new float[]{
            1f, 1f, 0.991f, 0.991f, 0.9833333333333333f, 0f, 0f, 0f,
            0.01134380453752181f, 0.015625000000000003f, 0.024193548387096798f,
            0.027397260273972573f, 0.017543859649122865f
        },
        new float[]{
            1f, 1f, 1f, 1f, 1f, 1f, 1f, 0.8434782608695652f, 1f, 1f, 1f, 1f,
            1f
        },
        new float[]{
            0.04f, 0.09f, 0.14f, 0.2f, 0.27450980392156865f,
        ...
        new TonalPalette(
        new float[]{
            0.638f, 0.638f, 0.6385767790262171f, 0.6301169590643275f,
        ...
        new float[]{
            1f, 1f, 1f, 1f, 0.9014084507042253f, 0.8128654970760234f,
            0.7979797979797981f, 0.7816593886462883f, 0.778723404255319f, 1f, 1f,
            1f
        },
        new float[]{
            0.05f, 0.12f, 0.17450980392156862f, 0.2235294117647059f,
        ...
        new TonalPalette(
        new float[]{
            0.563f, 0.569f, 0.5666f, 0.5669934640522876f, 0.5748031496062993f,
        ...
        new float[]{
            1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 0.8847736625514403f, 1f, 1f,
            1f
        },
        new float[]{
            0.07f, 0.12f, 0.16f, 0.2f, 0.24901960784313726f,
        ...
        new TonalPalette(
        new float[]{
            0.333f, 0.333f, 0.333f, 0.3333333333333333f, 0.3333333333333333f,
        ...
        new float[]{
            0.70f, 0.72f, 0.69f, 0.6703296703296703f, 0.728813559322034f,
        ...
        new TonalPalette(
        new float[]{
            0.161f, 0.163f, 0.163f, 0.162280701754386f, 0.15032679738562088f,
        ...
        new float[]{
            0.05f, 0.08f, 0.11f, 0.14901960784313725f, 0.2f,
        ...
        new TonalPalette(
        new float[]{
            0.108f, 0.105f, 0.105f, 0.105f, 0.10619469026548674f,
        ...
        new float[]{
            0.17f, 0.22f, 0.28f, 0.35f, 0.44313725490196076f,
        ...
        new TonalPalette(
        new float[]{
            0.036f, 0.036f, 0.036f, 0.036f, 0.03561253561253561f,
        ...
        new float[]{1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f},
        new float[]{
            0.19f, 0.26f, 0.34f, 0.39f, 0.4588235294117647f, 0.5f, 0.5f, 0.5f,
            0.5f, 0.5f, 0.5f, 0.6509803921568628f, 0.7803921568627451f, 0.9f
        }
        ),
        new TonalPalette(
        new float[]{
            0.955f, 0.961f, 0.958f, 0.9596491228070175f, 0.9593837535014005f,
        ...
        new float[]{
            0.87f, 0.85f, 0.85f, 0.84070796460177f, 0.8206896551724138f,
            0.7979797979797981f, 0.7661290322580644f, 0.9051724137931036f,
            1f, 1f, 1f, 1f, 1f
        },
        new float[]{
            0.06f, 0.11f, 0.16f, 0.22156862745098038f, 0.2843137254901961f,
        ...
        new TonalPalette(
        new float[]{
            0.866f, 0.855f, 0.841025641025641f, 0.8333333333333334f,
        ...
        new float[]{
            0.05f, 0.08f, 0.12745098039215685f, 0.15490196078431373f,
        ...
        new TonalPalette(
        new float[]{
            0.925f, 0.93f, 0.938f, 0.947f, 0.955952380952381f,
        ...
        new float[]{
            1f, 1f, 1f, 1f, 1f, 0.8350515463917526f, 0.6929460580912863f,
        ...
        new TonalPalette(
        new float[]{
            0.733f, 0.736f, 0.744f, 0.7514619883040936f, 0.7679738562091503f,
        ...
        new float[]{
            1f, 1f, 1f, 1f, 1f, 0.8163265306122449f, 0.6653386454183268f,
            0.7547169811320753f, 0.929824561403509f, 0.9558823529411766f,
            0.9560439560439562f, 1f, 1f
        },
        new float[]{
            0.07f, 0.12f, 0.17f, 0.2235294117647059f, 0.3f,
        ...
        new float[]{
            0.25f, 0.24590163934426232f, 0.17880794701986752f,
        ...
        new float[]{
            0.18f, 0.2392156862745098f, 0.296078431372549f,
        ...
        new TonalPalette(
        new float[]{
            0.938f, 0.944f, 0.952f, 0.961f, 0.9678571428571429f,
        ...
        new float[]{
            1f, 1f, 1f, 1f, 1f, 0.7023255813953488f, 0.6638655462184874f,
        ...
        new TonalPalette(
        new float[]{
            0.669f, 0.680f, 0.6884057971014492f, 0.6974789915966387f,
        ...
        new float[]{
            0.81f, 0.81f, 0.8214285714285715f, 0.6878612716763006f,
        ...
        new float[]{
            0.12f, 0.16f, 0.2196078431372549f, 0.33921568627450976f,
        ...
        new TonalPalette(
        new float[]{
            0.6470588235294118f, 0.6516666666666667f, 0.6464174454828661f,
            0.6441441441441442f, 0.6432748538011696f, 0.6416666666666667f,
            0.6402439024390243f, 0.6412429378531074f, 0.6435185185185186f,
            0.6428571428571429f
        },
        new float[]{
            0.8095238095238095f, 0.6578947368421053f, 0.5721925133689839f,
        ...
        new float[]{
            0.16470588235294117f, 0.2980392156862745f, 0.36666666666666664f,
        ...
        new TonalPalette(
        new float[]{
            0.469f, 0.46732026143790845f, 0.4718614718614719f,
        ...
        new float[]{
            1f, 1f, 1f, 1f, 1f, 1f, 0.6274509803921569f, 0.41832669322709176f,
            0.41899441340782106f, 0.4128440366972478f, 0.4090909090909088f
        },
        new float[]{
            0.07f, 0.1f, 0.15098039215686274f, 0.20588235294117646f,
        ...
        new TonalPalette(
        new float[]{
            0.542f, 0.5444444444444444f, 0.5555555555555556f,
        ...
        new float[]{
            0.25f, 0.24590163934426232f, 0.19148936170212766f,
        ...
        new float[]{
            0.05f, 0.1196078431372549f, 0.1843137254901961f,
            0.2627450980392157f,
        ...
        new TonalPalette(
        new float[]{
            0.022222222222222223f, 0.02469135802469136f, 0.031249999999999997f,
        ...
        new float[]{
            0.33333333333333337f, 0.2783505154639175f, 0.2580645161290323f,
        ...
        new float[]{
            0.08823529411764705f, 0.19019607843137254f, 0.2431372549019608f,
        ...
        new TonalPalette(
        new float[]{
            0.027f, 0.03f, 0.038f, 0.044f, 0.050884955752212385f,
        ...
        new float[]{1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f, 1f},
        new float[]{
            0.25f, 0.3f, 0.35f, 0.4f, 0.44313725490196076f, 0.5f, 0.5f, 0.5f,
